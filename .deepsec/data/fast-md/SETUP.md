# Agent setup for `fast-md`

This is a deepsec scanning workspace. Project `fast-md` was just registered
(target: `..`). Setup is incomplete — `data/fast-md/INFO.md`
...
2. **Fill in `data/fast-md/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id fast-md
pnpm deepsec process --project-id fast-md
```
